...
Canonical project contract for AI agents working in Temperance. System and
runtime instructions still take precedence over repository docs.
...
- Workout strings and `weekly_baseline` are hard project invariants.
